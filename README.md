...
**Senior Software Engineer (SDE IV) with 7+ years of experience, operating at an Enterprise Architect / Solution Architect level — specializing in payments infrastructure, technology strategy, and cloud architecture. AWS Certified Solutions Architect (SAA-C03, 940/1000).** I write publicly about enterprise architecture, distributed systems, database internals, and AI security at [kuldeepstechwork.com](https://kuldeepstechwork.com).
