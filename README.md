...
**Senior Software Engineer (SDE IV) at Easebuzz with 7+ years of experience, specializing in payments infrastructure, technology strategy, and cloud architecture. AWS Certified Solutions Architect (SAA-C03, 940/1000).** Career goal: Enterprise Architect | Solution Architect. I write publicly about enterprise architecture, distributed systems, database internals, and AI security at [kuldeepstechwork.com](https://kuldeepstechwork.com).
